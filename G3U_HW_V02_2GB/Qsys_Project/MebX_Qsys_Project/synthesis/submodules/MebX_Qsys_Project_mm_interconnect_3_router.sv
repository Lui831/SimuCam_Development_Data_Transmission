...
(
    ...
    localparam PAD14 = log2ceil(64'h80008000 - 64'h80004000); 
    localparam PAD15 = log2ceil(64'h8000c000 - 64'h80008000); 
    localparam PAD16 = log2ceil(64'h80010000 - 64'h8000c000); 
    localparam PAD17 = log2ceil(64'h80014000 - 64'h80010000); 
    localparam PAD18 = log2ceil(64'h80018000 - 64'h80014000); 
    localparam PAD19 = log2ceil(64'h8001c000 - 64'h80018000); 
    localparam PAD20 = log2ceil(64'h80020000 - 64'h8001c000); 
    localparam PAD21 = log2ceil(64'h80024000 - 64'h80020000); 
    localparam PAD22 = log2ceil(64'h80300000 - 64'h80200000); 
    localparam PAD23 = log2ceil(64'h82001000 - 64'h82000000); 
    localparam PAD24 = log2ceil(64'h88000000 - 64'h84000000); 
    localparam PAD25 = log2ceil(64'h8a000400 - 64'h8a000000); 
    localparam PAD26 = log2ceil(64'h8a001400 - 64'h8a001000); 
    localparam PAD27 = log2ceil(64'ha0000080 - 64'ha0000000); 
    // -------------------------------------------------------
    // Work out which address bits are significant based on the
    // address range of the slaves. If the required width is too
    // large or too small, we use the address field width instead.
    // -------------------------------------------------------
    localparam ADDR_RANGE = 64'ha0000080;
    ...
    if ( {address[RG:PAD25],{PAD25{1'b0}}} == 32'h8a000000   ) begin
            src_channel = 28'b0000000000000000100000000000;
            src_data[PKT_DEST_ID_H:PKT_DEST_ID_L] = 9;
    end

    // ( 0x8a001000 .. 0x8a001400 )
    if ( {address[RG:PAD26],{PAD26{1'b0}}} == 32'h8a001000   ) begin
            src_channel = 28'b0000000000000000010000000000;
            src_data[PKT_DEST_ID_H:PKT_DEST_ID_L] = 8;
    end

    // ( 0xa0000000 .. 0xa0000080 )
    if ( {address[RG:PAD27],{PAD27{1'b0}}} == 32'ha0000000   ) begin
